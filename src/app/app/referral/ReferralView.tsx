...
const i18n: Record<string, Record<string, string>> = {
    ...
    de: {
        ...
        balance: 'Bonus (€)',
        copied: 'Link kopiert!',
        shareText: 'Schau dir diesen Immobilienkatalog an — tolle Angebote zur Miete und zum Kauf!',
    ...
    es: {
        ...
        shareText: '¡Mira este catálogo inmobiliario: excelentes ofertas de alquiler y compra!',
    ...
    ar: {
        ...
        shareText: 'تحقق من كتالوج العقارات هذا - عروض رائعة للإيجار والشراء!',
    ...
    fr: {
        ...
        balance: 'Bonus (€)',
        copied: 'Lien copié !',
        shareText: 'Consultez ce catalogue immobilier — d\'excellentes offres pour la location et l\'achat !',
