...
const RENTAL_TAGS = [
    "near_sea", "sea_view", "pool", "indoor_pool", "parking", "security",
    "fitness", "sauna", "jacuzzi", "furnished", "wi_fi", "air_conditioning",
    "tv", "washing_machine", "dishwasher", "pet_friendly", "child_friendly",
    "balcony", "bbq", "work_space"
];
        ...
        async function fetchUnit() {
            try {
                ...
                setForm({
                    ...
                    price_per_day: u.price_per_day != null ? String(u.price_per_day) : "",
                    ...
                    max_guests: u.max_guests != null ? String(u.max_guests) : "",
                    ai_instructions: u.ai_instructions || "",
                });
                setSelectedTags(Array.isArray(u.features) ? u.features : []);
                setPhotos(Array.isArray(u.photos) ? u.photos : []);
            } catch (e) {
                setNotFound(true);
            } finally {
                setFetching(false);
    ...
    if (notFound) {
        return (
            <div className="flex h-64 flex-col items-center justify-center gap-4 text-neutral-400">
                ...
                <button onClick={() => router.push("/app/rentals")} className="text-sm text-blue-400 hover:underline">
                    ← Вернуться к списку
                </button>
            </div>
        );
        ...
        <div className="mx-auto max-w-3xl pb-24 md:pb-10">
            <div className="sticky top-0 z-30 bg-neutral-950/80 backdrop-blur-md border-b border-neutral-800 px-4 py-4 md:px-6 mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-lg md:text-xl font-semibold text-white">Редактирование аренды</h1>
                        <p className="text-xs text-neutral-500 mt-0.5">{form.city}{form.address ? `, ${form.address}` : ""}</p>
                    </div>
                </div>
            </div>
                ...
                <form onSubmit={submit} className="space-y-8">
                    ...
                    <section>
                        ...
                        <div className="rounded-2xl border border-neutral-700 overflow-hidden bg-neutral-900/30 shadow-sm">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 border-b border-neutral-800 bg-neutral-900/60 p-4">
                                <div className="flex items-center flex-1 border-b md:border-b-0 md:border-r border-neutral-800 pb-2 md:pb-0 md:pr-4">
                                ...
                                <div className="flex items-center flex-1 pt-2 md:pt-0 md:pl-4">
                                    <div className="w-full">
                            ...
                            <div className="grid grid-cols-3 divide-x divide-neutral-800">
                                <div className="p-3 text-center group focus-within:bg-neutral-900/50 transition-colors">
                                    <label className="block text-[10px] text-neutral-500 uppercase tracking-wider mb-1 font-semibold">Спален</label>
                                    <input
                                        type="number"
                                ...
                                <div className="p-3 text-center group focus-within:bg-neutral-900/50 transition-colors">
                                    <label className="block text-[10px] text-neutral-500 uppercase tracking-wider mb-1 font-semibold">Ванных</label>
                                    <input
                                        type="number"
                                        className="w-full bg-transparent text-center text-neutral-200 placeholder:text-neutral-700 outline-none text-sm font-medium"
                                        placeholder="1"
                        ...
                        <details className="group">
                            ...
                            <div className="mt-3">
                                <textarea
                                    ...
                                    placeholder="Инструкции для ИИ (например: 'Аренда минимум на неделю')"
                    ...
                    <div className="fixed bottom-0 left-0 right-0 p-4 bg-neutral-950/90 backdrop-blur-lg border-t border-neutral-800 md:static md:bg-transparent md:border-0 md:p-0 z-40">
                        ...
                        <Button
                            ...
                            className={`w-full py-4 text-base font-semibold shadow-xl transition-all ${loading || !form.city
